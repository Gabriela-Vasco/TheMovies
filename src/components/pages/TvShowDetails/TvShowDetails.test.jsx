...
describe("TvShowDetails", () => {
  const server = setupServer(
    rest.get(`https://api.themoviedb.org/3/tv/549?${apiKey}`, (req, res, ctx) => {
  ...
  it("should render correctly", () => {
    ...
    const tvShowDetailsTitle = screen.getByText("Voltar");
    expect(tvShowDetailsTitle).toBeInTheDocument();
  });

  it("should call render movie details", async () => {
      render(
        <BrowserRouter>
          <TvShowDetails />
        </BrowserRouter>
    ...
    waitFor(() => {
      const tvShowDetailsTitle = screen.getByText("Lei & Ordem (1990)");
      expect(tvShowDetailsTitle).toBeInTheDocument();
    });
  });
